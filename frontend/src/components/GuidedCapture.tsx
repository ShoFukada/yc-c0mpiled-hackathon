						...
						<div className="animate-fade-in-up delay-200">
							{isUploaded ? (
								...
								<button
									type="button"
									onClick={() => inputRef.current?.click()}
									className="group w-full rounded-xl border border-dashed border-border-medium bg-surface-raised/50 p-8 transition-all duration-200 hover:border-accent/40 hover:bg-accent/5 cursor-pointer"
								>
									<div className="flex flex-col items-center gap-3">
										<div className="w-12 h-12 rounded-full bg-surface-overlay flex items-center justify-center group-hover:bg-accent/10 transition-colors">
											<svg
						...
						<div className="flex gap-3 pt-2 animate-fade-in-up delay-300">
							...
							{isLast ? (
								<button
									...
									className="flex-[2] px-4 py-3 rounded-xl bg-accent text-surface font-display font-700 text-sm hover:bg-accent-light transition-all duration-200 shadow-[0_0_20px_-6px_rgba(201,160,68,0.3)] disabled:opacity-40 disabled:cursor-not-allowed"
								>
									Complete
								</button>
							) : (
								<button
									type="button"
									onClick={handleNext}
									className="flex-[2] px-4 py-3 rounded-xl bg-accent text-surface font-display font-700 text-sm hover:bg-accent-light transition-all duration-200 shadow-[0_0_20px_-6px_rgba(201,160,68,0.3)]"
								>
									Next Point
								</button>
							)}
